...
const demo = { 
  entityMap: {
    ...
    "3": {
      ...
      data: {
        href:
          // tslint:disable-next-line:max-line-length
          "http://www.techtimes.com/articles/136493/20160225/facebook-addiction-affects-brain-like-cocaine-gambling-study.htm",
        url:
          // tslint:disable-next-line:max-line-length
          "http://www.techtimes.com/articles/136493/20160225/facebook-addiction-affects-brain-like-cocaine-gambling-study.htm"
      }
    ...
    "8": {
      ...
      data: {
        href:
          // tslint:disable-next-line:max-line-length
          "http://www.parentherald.com/articles/73928/20161015/google-secures-patent-smart-contact-lenses-designed-diabetics.htm",
        url:
          // tslint:disable-next-line:max-line-length
          "http://www.parentherald.com/articles/73928/20161015/google-secures-patent-smart-contact-lenses-designed-diabetics.htm"
      }
    ...
    "9": {
      ...
      data: {
        href:
          "http://mashable.com/2016/04/05/samsung-smart-contact-lenses-patent/#fV7S6EX8DaqP",
        url:
          "http://mashable.com/2016/04/05/samsung-smart-contact-lenses-patent/#fV7S6EX8DaqP"
      }
    },
    ...
    "11": {
      ...
      data: {
        href:
          "https://backchannel.com/twitch-could-be-a-20-billion-dollar-company-inside-amazon-2507b7f9aa6d",
        url:
          "https://backchannel.com/twitch-could-be-a-20-billion-dollar-company-inside-amazon-2507b7f9aa6d"
      }
    },
    "12": {
      ...
      mutability: "MUTABLE",
      data: {
        href: "http://www.thewildernessdowntown.com/",
    ...
    "13": {
      ...
      mutability: "MUTABLE",
      data: {
        href: "http://nightmare.mit.edu/",
        url: "http://nightmare.mit.edu/"
      }
    },
    "14": {
      type: "LINK",
    ...
    "16": {
      ...
      mutability: "MUTABLE",
      data: {
        href: "https://www.safebeyond.com/",
        url: "https://www.safebeyond.com/"
      }
    },
    "17": {
      type: "LINK",
    ...
    "18": {
      ...
      data: {
        href:
          "http://www.theverge.com/2016/6/21/11995032/mark-zuckerberg-webcam-tape-photo",
        url:
          "http://www.theverge.com/2016/6/21/11995032/mark-zuckerberg-webcam-tape-photo"
      }
    },
    "19": {
      ...
      data: {
        href:
          "http://www.cnn.com/2012/07/14/world/americas/brazil-alternative-sentence-reduction/",
        url:
          "http://www.cnn.com/2012/07/14/world/americas/brazil-alternative-sentence-reduction/"
      }
    },
    ...
    "21": {
      ...
      mutability: "MUTABLE",
      data: {
        href: "http://time.com/4043311/david-cameron-pig-gate-scandal/",
        url: "http://time.com/4043311/david-cameron-pig-gate-scandal/"
      }
    },
    "22": {
      type: "LINK",
      mutability: "MUTABLE",
      data: {
        href: "http://news.bbc.co.uk/2/hi/uk_news/661139.stm",
        url: "http://news.bbc.co.uk/2/hi/uk_news/661139.stm"
      }
    },
    "23": {
      type: "LINK",
      ...
      data: {
        href:
          "https://windagainstcurrent.files.wordpress.com/2014/07/manhattanhenge-8.jpg",
        url:
          "https://windagainstcurrent.files.wordpress.com/2014/07/manhattanhenge-8.jpg"
      }
    }
  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        enabled: false,
        aspect_ratio: { width: 800, height: 14, ratio: 1.7500000000000002 },
        width: 800,
        height: 14,
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*7558zQdffG0nE6eA8sIudQ.png",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    {
      key: "anhe0",
      text: "The Waldo Moment (season 2, episode 3)",
      type: "header-four",
      depth: 0,
      inlineStyleRanges: [{ offset: 0, length: 38, style: "BOLD" }],
      entityRanges: [],
      data: {}
    },
    {
      ...
      data: {
        enabled: false,
        aspect_ratio: { width: 800, height: 401, ratio: 50.125 },
        width: 800,
        height: 401,
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*u9nzrQNXIo5pvNx9Ywfc7w.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      inlineStyleRanges: [
        ...
        { offset: 908, length: 12, style: "ITALIC" }
      ],
      entityRanges: [{ offset: 475, length: 18, key: 0 }],
      data: {}
    },
    {
      key: "2udte",
      text: "Nosedive (season 3, episode 1)",
      type: "header-four",
      depth: 0,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*VSYQZNBOryr5kxstmUKGKg.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*gnRUO5LE1qyOXMVo05BjZA.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*gJkyxh7jfu5hEgs6QJxnyA.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*bPQ7oBPEOg0ISwLUnsjLSw.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      text:
        // tslint:disable-next-line:max-line-length
        "“Playtest” follows wanderlust-stricken Cooper (Wyatt Russell) as he offers himself as a test subject for an augmented reality horror game—an experiment that turns fatal. All the tenets of this episode link back to reality: First, there’s the barely disguised TaskRabbit (dubbed “OddJobs”) on which Cooper finds his game-testing gig. The game he ends up playing is a mix of Pokémon Go and the myriad other augmented reality games out there; it also draws from biofeedback-enhanced games, such as Nevermind, which read players’ stress levels and adjust gameplay accordingly.But what really brings the terror in “Playtest” is that the game uses a neural net to learn and build on the player’s worst fears. For Cooper, those include spiders, a deranged doppelgänger of his recent hookup, and his mother suffering from Alzheimer’s. It’s a terrifying version of that 2010 Arcade Fire music video, which used Google Maps and html5 to set the video in the viewer’s childhood neighborhood. Pair that with MIT’s Nightmare Machineproject, which makes even the most innocuous of images scary, and you’ve got something pretty close to the freaky tech presented here — lethal side effects (hopefully) not included.",
      type: "unstyled",
      depth: 0,
      inlineStyleRanges: [{ offset: 0, length: 45, style: "BOLD" }],
      entityRanges: [
        { offset: 878, length: 11, key: 12 },
        { offset: 996, length: 23, key: 13 }
      ],
      data: {}
    },
    {
      key: "284s1",
      text: "Be Right Back (season 2, episode 1)",
      type: "header-four",
      depth: 0,
      inlineStyleRanges: [{ offset: 0, length: 35, style: "BOLD" }],
      entityRanges: [],
      data: {}
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*SODulysFlTl6eiGUwln2GQ.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*6cWjeI5k0SOxNl0trJTX_w.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*wuL3VA4AgbpdMfs9RCIUwg.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    {
      key: "13aa",
      text: "Fifteen Million Merits (season 1, episode 2)",
      type: "header-four",
      depth: 0,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*LXNImOG3Hp8MTn6JeBlqyg.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*qf7CX4IYmgLGcISKFaDyEw.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    {
      key: "6uprp",
      text: "San Junipero (season 3, episode 4 )",
      type: "header-four",
      depth: 0,
      inlineStyleRanges: [{ offset: 0, length: 35, style: "BOLD" }],
      entityRanges: [],
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*exG3QaU4M3UcKyBfzEjkEA.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*uXZdF0yUsRAnqZ66Jg89EA.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*BDMCIns12g67lhhQX2m96Q.jpeg",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      data: {
        ...
        forceUpload: false,
        url:
          "https://cdn-images-1.medium.com/max/800/1*GpmBzpGpmYrfDNiqABzipw.png",
        loading_progress: 0,
        selected: false,
        loading: false,
        file: null,
    ...
    },
    {
      ...
      text:
        // tslint:disable-next-line:max-line-length
        "Are you, too, turning to the dystopian world of Black Mirror as a dark oracle of things to come? Or maybe you’re just enjoying it for its entertainment value? Either way, if we missed a real-world parallel, let us know below.",
      type: "unstyled",
      depth: 0,
      inlineStyleRanges: [
        { offset: 0, length: 13, style: "BOLD" },
        { offset: 48, length: 12, style: "ITALIC" }
      ],
      entityRanges: [],
      data: {}
    }
...
class TextEditor extends React.Component<any, any> {
  ...
  render() {
    return <DanteEditor content={demo} config={this.options} />;
  }
}
